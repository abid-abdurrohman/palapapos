...
public class Budaya extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        Budaya.ViewPagerAdapter adapter = new Budaya.ViewPagerAdapter(getSupportFragmentManager());
        adapter.addFragment(new BudayaHome(), "Budaya");
        adapter.addFragment(new BudayaTerkini(), "Berita Terkini");
        adapter.addFragment(new BudayaTerpopuler(), "Berita Populer");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.home:
                finish();
            case R.id.about_us:
                Intent about_us = new Intent(Budaya.this, AboutUs.class);
                startActivity(about_us);
                return true;
            case R.id.privacy_policy:
                Intent privacy_policy = new Intent(Budaya.this, PrivacyPolicy.class);
                startActivity(privacy_policy);
                return true;
            case R.id.term_of_use:
                Intent term_of_use = new Intent(Budaya.this, TermOfUse.class);
                startActivity(term_of_use);
                return true;
            case R.id.info_iklan:
                Intent info_iklan = new Intent(Budaya.this, InfoIklan.class);
                startActivity(info_iklan);
                return true;
            case R.id.redaksi:
                Intent redaksi = new Intent(Budaya.this, Redaksi.class);
                startActivity(redaksi);
                return true;
            case R.id.contact_us:
                Intent contact_us = new Intent(Budaya.this, ContactUs.class);
